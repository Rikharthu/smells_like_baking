...
import com.uv.smellslikebakin.DirectionsFragment;
import com.uv.smellslikebakin.IngredientsFragment;
import com.uv.smellslikebakin.R;
import com.uv.smellslikebakin.Recipes;
import com.uv.smellslikebakin.ViewPagerFragment;
...
public class DualPaneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Check if there are no saved fragments (in ViewPagerFragment ViewPager does this for us)
